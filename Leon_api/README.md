...
- 2026-05-30 当前未推修复方向：
  ...
  - 音质默认值已向质量侧移动：TAVO 默认 `qualityMode=balanced`，fast/balanced/expressive/ultra 对应 diffusion `8/14/16/20`；balanced/expressive/ultra 参考音频与分段窗口更长，默认采样 `top_p=0.8 temperature=0.7 repetition_penalty=1.2`。
