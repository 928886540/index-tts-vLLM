// IndexTTS Tavo runtime part: 05_style_config.js // Role: style loading, global config, message context // This fragment is concatenated by static/tavo.runtime.js; it is not a standalone script.
  function ensureStyle() {
    ...
    style.textContent += [
      ...
      ".idx-sub-toolbar{position:sticky!important;top:0!important;z-index:4!important;display:flex!important;align-items:center!important;gap:8px!important;flex:0 0 28px!important;min-height:28px!important;margin:0 0 5px!important;padding:2px 2px!important;border-radius:10px!important;background:linear-gradient(180deg,rgba(26,18,34,.94),rgba(26,18,34,.74))!important;-webkit-backdrop-filter:blur(10px)!important;backdrop-filter:blur(10px)!important;box-shadow:0 6px 14px rgba(0,0,0,.12)!important}",
      ...
      ".idx-sub-toolbar .idx-card-counter{position:static!important;right:auto!important;top:auto!important;flex:0 0 auto!important;min-width:44px!important;height:24px!important;padding:0 8px!important;pointer-events:none!important}",
      ".idx-sub-toolbar .idx-progress-line{display:block!important;flex:1 1 auto!important;min-width:0!important;height:24px!important;min-height:24px!important;line-height:24px!important;margin:0!important;color:rgba(238,231,244,.72)!important;font-size:12px!important;text-align:left!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:clip!important;scrollbar-width:none!important}",
      ".idx-sub-toolbar .idx-progress-line::-webkit-scrollbar{display:none!important}",
      ...
      ".idx-seek-wrap{flex:0 0 auto!important}.idx-subtitle{height:172px!important;min-height:172px!important;max-height:172px!important;flex:0 0 172px!important;padding:8px 10px 9px!important}.idx-sub-row{min-height:31px!important;padding:5px 8px!important}.idx-controls{flex:0 0 74px!important;gap:16px!important;flex-wrap:nowrap!important;margin-top:18px!important;margin-bottom:10px!important}.idx-ctrl-add{margin-left:22px!important}",
      "@media(max-width:520px){.idx-card{height:430px!important;min-height:430px!important}.idx-top{padding-top:0!important;padding-right:84px;min-height:56px}.idx-status{max-height:18px!important}.idx-gear,.idx-playback-toggle{top:25px!important;height:34px!important}.idx-gear{right:14px!important;width:40px!important}.idx-playback-toggle{right:58px!important;width:34px!important;min-width:34px!important}.idx-sub-delete{left:8px;top:8px;width:24px;height:22px}.idx-sub-toolbar{gap:6px!important}.idx-sub-toolbar .idx-card-counter{min-width:40px!important;padding:0 7px!important}.idx-controls{gap:13px!important;margin-bottom:10px!important}.idx-ctrl-add{margin-left:16px!important}.idx-live-exit{width:62px!important;height:62px!important;min-width:62px!important;min-height:62px!important}}"
    ].join("");
