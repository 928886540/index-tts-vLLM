...
def parse_text_openai_compatible(
    ...
    try:
        opener = _url_opener_for_endpoint(request_url)
...
def _url_opener_for_endpoint(endpoint: str):
    if _should_bypass_proxy(endpoint):
        return urllib.request.build_opener(urllib.request.ProxyHandler({}))
    return urllib.request.build_opener()


def _should_bypass_proxy(endpoint: str) -> bool:
