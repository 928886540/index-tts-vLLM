...
```html
<script src="http://<LAN-IP>:9880/static/tavo.js?v=20260607-ai-live-v27"></script>
```

Current code state:

- `static/tavo.js`, `static/tavo.runtime.js`, `static/tavo.runtime.manifest.json`, and `README.md` use `20260607-ai-live-v27`.
