...
- Playwright smoke confirms progress now lives as a transparent one-line `.idx-card` bottom hint; delete and page counter stay in the sticky `.idx-subtitle .idx-sub-toolbar`, and card height remains `450px`.
