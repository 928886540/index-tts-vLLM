...
- `生成记录` should include readable history under `outputs/cache/by_role/<role>/**/*.json`, dedupe records by cache key, and still find audio size/format from top-level cache files or readable-cache sidecar files.
