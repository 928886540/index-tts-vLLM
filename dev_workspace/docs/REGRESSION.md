...
- foreground visibility return must not require a resume click or `start_s` reconnect; only the user pressing the player pause button may enter paused state;
